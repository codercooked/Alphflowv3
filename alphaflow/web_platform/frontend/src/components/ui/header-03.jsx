...
import { ArrowUpRight, Equal, X, Moon, Sun } from "lucide-react";
...
export function Header() {
  ...
  return (
    <header className="fixed top-4 left-1/2 -translate-x-1/2 w-max z-50 bg-black/40 backdrop-blur-xl border border-white/10 rounded-full shadow-2xl">
      <div className="px-2">
        <div className="flex items-center justify-between h-12 gap-4">
          <div className="flex bg-black/50 border border-white/5 rounded-full h-8 px-3 items-center">
            <a
              href="#"
              aria-label="home"
            ...
            >
              <img
                ...
                height={24}
                width={24}
                className="h-5 z-10 w-full object-contain"
              />
              <span className="font-semibold pr-2 hidden md:block text-white text-base tracking-tight">
                AlphaFlow
              </span>
            </a>
          </div>
          ...
          <nav className="hidden lg:flex items-center">
            <NavigationMenu viewport={true}>
              <NavigationMenuList className="gap-1">
                {/* Stocks */}
                <NavigationMenuItem>
                  <NavigationMenuTrigger className="bg-transparent h-8 px-3 text-xs font-semibold text-white hover:bg-white/10 rounded-full transition-colors">
                    Stocks
                  </NavigationMenuTrigger>
                  <NavigationMenuContent>
                ...
                {/* Mutual Funds */}
                <NavigationMenuItem>
                  <NavigationMenuTrigger className="bg-transparent h-8 px-3 text-xs font-semibold text-red-500 hover:text-red-400 hover:bg-white/10 rounded-full transition-colors drop-shadow-[0_0_8px_rgba(239,68,68,0.4)]">
                    Mutual Funds
                  </NavigationMenuTrigger>
                  <NavigationMenuContent>
                    <ul className="grid w-[550px] gap-3 p-4">
          ...
          <div className="hidden gap-1 lg:flex items-center">
            <ModeToggle />
            <Button className="px-4 h-8 bg-[#8bbc40] text-black hover:bg-[#78a536] rounded-full text-xs font-bold shadow-[0_0_12px_rgba(139,188,64,0.3)] transition-colors">
